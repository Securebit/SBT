...
// SecureBit: attempt to generate suitable proof-of-stake
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x6c659c5106a574034ead4276f4fa4cdd0ec0c19b31d4202ae10a66b493b6a0ac"));
        block.print();
